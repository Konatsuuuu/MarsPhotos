...
sealed interface MarsUiState {
    data class Success(val photos: List<Student>) : MarsUiState
    object Error : MarsUiState
    object Loading : MarsUiState
}

class MarsViewModel(private val marsPhotosRepository: StudentsRepository) : ViewModel() {
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                MarsViewModel(marsPhotosRepository = studentsRepository)
            }
        }
    }
}
